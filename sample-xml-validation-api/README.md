...
- Retrieve the OpenAPI specification in JSON format: `curl -H 'Accept: application/json' http://localhost:8080/validateMembershipXML/api-doc` or `curl http://localhost:8080/validateMembershipXML/api-doc/swagger.json`

```zsh
$ curl -H 'Accept: application/json' http://localhost:8080/validateMembershipXML/api-doc
```
```json
{
  "swagger" : "2.0",
...
- Retrieve the OpenAPI specification in YAML format: `curl -H 'Accept: text/yaml' http://localhost:8080/validateMembershipXML/api-doc` or `curl http://localhost:8080/validateMembershipXML/api-doc/swagger.yaml`

```zsh
$ curl -H 'Accept: text/yaml' http://localhost:8080/validateMembershipXML/api-doc
```
```yaml
---
swagger: "2.0"
...
For example, `http://sample-xml-validation-api.apps.cluster-4e2c.sandbox1596.opentlc.com/validateMembershipXML/api-doc/swagger.yaml` will return the OpenAPI specification of the service in YAML format.