...
```json
{
    ...
    "servers": [
        {
            "url": "https://xml-validation-api.apps.jeannyil.sandbox235.opentlc.com"
        }
    ],
    "paths": {
...
For example, `http://sample-xml-validation-api.apps.jeannyil.sandbox235.opentlc.com/openapi.json` will return the OpenAPI specification of the service.