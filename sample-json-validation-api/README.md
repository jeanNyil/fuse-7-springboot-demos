...
For example, `http://sample-json-validation-api.apps.cluster-ce1b.sandbox753.opentlc.com/openapi.json` will return the OpenAPI specification of the service.