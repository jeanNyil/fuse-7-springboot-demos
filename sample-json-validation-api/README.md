...
```json
{
    ...
    "servers": [
        {
            "url": "http://sample-json-validation-api.apps.jeannyil.sandbox235.opentlc.com",
...
For example, `http://sample-json-validation-api.apps.jeannyil.sandbox235.opentlc.com/openapi.json` will return the OpenAPI specification of the service.